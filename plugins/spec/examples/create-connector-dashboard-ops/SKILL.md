---
name: create-connector-dashboard-ops
description: Create a connector-backed operations dashboard prototype for customer success, support, or launch review workflows.
license: MIT
metadata:
...
# Example Connector Ops Dashboard

Use this plugin when the user asks for a connector-backed dashboard prototype that summarizes changing operational data.
