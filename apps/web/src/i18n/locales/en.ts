...
export const en: Dict = {
  ...
  'chat.mode.design.summary': 'For creating or changing concrete outputs: pages, prototypes, live artifacts, slides, images, videos, audio, dashboards, and project files.',
