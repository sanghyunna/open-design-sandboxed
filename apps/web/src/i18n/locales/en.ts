...
export const en: Dict = {
  ...
  'hosted.provider.eyebrow': 'Hosted Open Design',
  ...
  'settings.codeAgentsSubtitle': 'Choose which coding agents appear in Open Design.',
  ...
  'chat.mode.design.solves': 'Use it when you want Open Design to generate files, update the workspace, or turn a brief into deliverables.',
