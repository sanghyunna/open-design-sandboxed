...
_Generated by \`apps/landing-page/scripts/blog-indexing/render-status.ts\`.
Do not hand-edit; the sidecar JSON at \`docs/blog-indexing-status.json\` is
the source of truth and the next script run will overwrite this file._
...
\`Crawled - currently not indexed\` past the T+7 window, run the escalation
script to open a tracking issue.
