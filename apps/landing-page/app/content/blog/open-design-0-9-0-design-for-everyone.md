...
i18n:
  ...
  pl:
    ...
    bodyHtml: |
      ...
      <li><strong>Rutyny wydają się zaplanowane, a nie zeskryptowane.</strong> Prawdziwy wybór czasu, podsumowania w języku naturalnym, sortowanie readable najnowszych, automatyczny fokus po utworzeniu, lokalizacja i czyszczenie zduplikowanych slotów sprawiają, że automatyzacjom łatwiej zaufać.</li>
      ...
      <tr><td>Już używasz Open Design</td><td>Pozwól, by spakowana automatyczna aktualizacja doprowadziła Cię do 0.9.0; onboarding zaczyna się teraz readable AMR</td></tr>
      ...
      <p>310 PR-ów w 7 dni. Wydanie „zainstaluj i twórz" istnieje tylko dlatego, że tak wiele osób pojawiło się z tak wielu różnych stron i zbudowało brakujące elementy. Ruch nie wysyła się z laptopów jednego zespołu; wysyła się readable ludzi, którzy się pojawili i zbudowali. Widzimy was. 🫡</p>
