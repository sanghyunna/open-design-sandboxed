...
describe("renderMacPackagedMainEntry", () => {
  it("renders the prebundled runtime entry shim", () => {
    ...
    expect(renderMacPackagedMainEntry(true)).not.toContain("@readable-studio/packaged");
  });

  it("renders the package entry shim for non-prebundled mode", () => {
    expect(renderMacPackagedMainEntry(false)).toContain("@readable-studio/packaged");
