...
export async function collectMacSizeReport(
  ...
  return {
    ...
    tracked: {
      ...
      webNextCacheBytes: await sizePathBytes(join(appNodeModulesRoot, "@readable-studio", "web", ".next", "cache")),
      webPackageBytes: await sizePathBytes(join(appNodeModulesRoot, "@readable-studio", "web")),
      webPackageStandaloneBytes: await sizePathBytes(join(appNodeModulesRoot, "@readable-studio", "web", ".next", "standalone")),
    },
